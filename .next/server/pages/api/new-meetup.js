...
async function handler(req, res) {
    if (req.method === "POST") {
        const data = req.body;
        const client = await external_mongodb_namespaceObject.MongoClient.connect("mongodb+srv://Zare:Srbija92@cluster0.hwou0.mongodb.net/meetups?retryWrites=true&w=majority");
        const db = client.db();
